...
<div class="row">
    <form id="form_total" class="form sign-in" role="form" action="./creer.php" method="post" enctype="multipart/form-data">
        ...
        <div class="col">
            <div class="container actif menu-partie" id="menu1">
                ...
                <div class="form-group" id="fleche1">
                    <div class="col-sm-10 offset-sm-1">
                        <button name="action" value="creer" id="bouton1" class="btn btn-primary btn-block etape-suivante">Etape suivante</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group" id="fleche2">
                                <button name="action" value="creer" id="bouton3" class="btn btn-primary btn-block etape-precedente">Etape précédente</button>
                            </div>
                        </div>
                        <div class="col">   
                            <div class="form-group" id="fleche3">
                                <button name="action" value="creer" id="bouton2" class="btn btn-primary btn-block etape-liste-suivante">Etape suivante</button>                            
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="equipe1" id="liste3">
                    ...
                    <div class="form-group">
                        <div class="col-sm-10 offset-sm-1">
                            ...
                            <input type="file" name="img_role" accept=".jpg,.png,.jpeg,.gif" class="form-control" id="img_role">
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group" id="fleche4">
                                    <button name="action" value="creer" id="bouton3" class="btn btn-primary btn-block etape-surplace">Etape précédente</button>
                                </div>
                            </div>
                            <div class="col">   
                                <div class="form-group" id="fleche5">
                                    <button name="action" value="creer" id="bouton3" class="btn btn-primary btn-block etape-liste-suivante">Etape suivante</button>                            
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group" id="fleche6">
                                <button name="action" value="creer" id="bouton4" class="btn btn-primary btn-block etape-precedente">Etape précédente</button>
                            </div>
                        </div>
                        <div class="col">   
                            <div class="form-group" id="fleche7">
                                <button name="action" value="creer" id="bouton4" class="btn btn-primary btn-block etape-liste-suivante">Etape suivante</button>                            
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group" id="fleche8">
                                <button name="action" value="creer" id="bouton5" class="btn btn-primary btn-block etape-precedente">Etape précédente</button>
                            </div>
                        </div>
                        <div class="col">   
...
<script src="inclus/creer/creerModele_v2.js"></script>
