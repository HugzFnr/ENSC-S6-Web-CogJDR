<?php
    ...
    function retirer_equipe($id_joueur, $id_modele_equie, $id_jdr) {
        return $id_modele_equie != null && sql_delete('EstDans', array(
                'id_joueur' => $id_joueur,
                'id_equipe' => equipe_de_modele($id_modele_equie)
            ));
    }
    ...
    function effectuer_action($id_cible, $context) {
        ...
        retirer_equipe($cible['id_joueur'], $context['action']['action_effet_id_modele_equipe_depart'], $id_jdr);
        ajouter_equipe($cible['id_joueur'], $context['action']['action_effet_id_modele_equipe_arrive'], $id_jdr);
